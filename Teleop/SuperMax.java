...
@Disabled
@TeleOp(name="MAX VERSTAPEN", group="SUPERMAX")

public class SuperMax extends LinearOpMode {

    // Declare OpMode members for each of the 4 motors.
    public ElapsedTime runtime = new ElapsedTime();
    //public ElapsedTime time;
    public DcMotor LFD;//Left Front Drive
    public DcMotor LBD;//Left Back Drive
    public DcMotor RFD;//Right Front Drive
    public DcMotor RBD;//Right Back Drive

    public DcMotor armR;//Arm Rotate
    public Servo claw;
    public Servo claw2;
