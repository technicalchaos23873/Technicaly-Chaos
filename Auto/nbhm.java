...
import org.firstinspires.ftc.teamcode.Auto.IHaveThretyThousendDollorsInCreditcardDebp;

public class nbhm extends LinearOpMode {
    ...
    public final static double CLAW_MAX_RANGE = 0.9;        //Largest Number Value Allowed For Claw Position
    
    double clawPosition = CLAW_HOME;        //Sets Safe Position
    final double CLAW_SPEED = 0.7;      //Sets Safe Speed
    ...
    public final static double ELBOW_MAX_RANGE = 0.9;        //Largest Number Value Allowed For Claw Position

    double elbowPosition = CLAW_HOME;        //Sets Safe Position
    final double ELBOW_SPEED = 0.7;      //Sets Safe Speed
